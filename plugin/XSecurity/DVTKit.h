...
@class DVTCapacityViewController;
@class DVTCapacityView;
...
@class DVTGroupedAssetHighlightView;
...
@class DVTDraggedImageStateTransitionView;
@protocol DVTDynamicTableViewDelegate;
@protocol DVTDynamicTableViewDataSource;
@class DVTPlistNode;
@protocol DVTMainViewControllerDrawingStrategyDelegate;
@protocol DVTPlistDocumentProtocol;
@class DVTPlistStructureDefinition;
@class DVTPopUpButtonCell;
...
@class NSScrollImpPair;
@class DVTPlistPopupCell;
@class NSScrollerImpPair;
@class DVTMarkedScroller;
@protocol DVTTextStorageDelegate;
@protocol DVTScopeBarHost;
@class DVTPlistTitledPopupCell;
@class DVTHUDPopUpContentViewController;
@class DVTLibraryDetailEditorController;
...
@class DVTTextCompletionInlinePreviewController;
@class DVTFontPopUpViewController;
@protocol DVTFontTextFieldCellDelegate;
@class DVTAbstractColorPicker;
@class DVTTextLayer;
@protocol DVTColoredSpinnerDelegate;
@protocol DVTUndoManagerDelegate;
@class DVTPopoverContentViewController;
 ...
 * UUID: 0F9EC4BC-158C-3741-8E60-B781AF0CB667
 * Arch: x86_64
 *       Current version: 3553.0.0, Compatibility version: 1.0.0
 *       Source version: 3553.0.0.0.0
