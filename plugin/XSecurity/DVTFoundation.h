...
@class DVTExtensionElementDescription;
...
@class URegularExpression;
@class DVTStringBuffer;
@class DVTSourceScanner;
@class DVTSourceModelParserProductionRule;
@class DVTRegExScanner;
@protocol DVTSourceBufferProvider;
@class DVTSourceSpecification;
@class DVTBlockScanner;
@class DVTSourceModelItem;
@class DVTSourceModelParser;
@protocol DVTNodeTypeProvider;
@class DVTPlatform;
@class DVTDeviceType;
@class DVTDeviceLocator;
@class DVTPlatformFamily;
@class DVTVersion;
@class DVTCSourceModelParser;
@class DVTAbstractMacDevice;
@class DVTSearchPath;
@protocol DVTPackageInstallerHelperDelegate;
@class DVTCustomDataOwnership;
@protocol DVTDirectoryBasedCustomDataStoreDelegate;
@class DVTModelTreeNode;
@class DVTSimpleDeserializer;
@class DVTMacroExpansionOperator;
@class DVTMacroDefinitionConditionSet;
@class DVTDeveloperAccount;
@class DVTBuildVersion;
@class DVTSimpleSerializer;
@class DVTDotSeparatedVersion;
@class DVTDownloadableIndex;
@class DVTPointerFunctions;
...
@class DTDKDeveloperPortalService;
@class DVTPortalOperationToken;
@class DVTDeveloperPortalResponseWrapper;
 ...
 * UUID: 05454F93-F6FD-3813-B2B9-29D364BAE0F0
 * Arch: x86_64
 *       Current version: 3542.0.0, Compatibility version: 1.0.0
 *       Source version: 3542.0.0.0.0
...
@interface DVTMacroDefinitionTable : NSObject <NSCopying, NSMutableCopying>
{
    ...
    id _willSetValueBlock;
    id _didSetValueBlock;
}
...
- (void)enumerateValuesForMacroName:(id)arg1 usingBlock:(id)arg2;
...
- (BOOL)isEqual:(id)arg1;
- (unsigned long long)hash;
@property(copy) id didSetValueBlock;
@property(copy) id willSetValueBlock;
- (unsigned long long)count;
...
+ (id)optionDefinitionWithName:(id)arg1 usageName:(id)arg2 usageDescription:(id)arg3 argumentType:(long long)arg4 argumentKey:(id)arg5 handlerBlock:(id)arg6;
@property(copy) id handlerBlock; // @synthesize handlerBlock=_handlerBlock;
...
- (id)description;
- (id)initWithName:(id)arg1 usageName:(id)arg2 usageDescription:(id)arg3 argumentType:(long long)arg4 argumentKey:(id)arg5 handlerBlock:(id)arg6;
...
- (void)updateOutdatedDownloadables:(id)arg1 errorHandler:(id)arg2;
...
@interface DVTUpdateProfileOperation : DVTPortalOperation
{
}

+ (id)operationWithSingleTeamToken:(id)arg1 andProfileRecord:(id)arg2;
...
- (void)dvt_enumerateWhitespaceSeparatedSubstringsInRange:(struct _NSRange)arg1 usingBlock:(id)arg2;
...
@interface NSObject (DVTNSMutableCopyingAdditions_Internal)
- (void)_dvt_propagatePropertiesToCopiedObject:(id)arg1 copiedObjectIsMutable:(BOOL)arg2;
@end

@interface NSObject (DVTNSMutableCopyingAdditions)
+ (void)dvt_synthesizeMutableClassHierarchyWithMutableClass:(Class)arg1 mutableCopyablePropertyNames:(id)arg2 propertyNames:(id)arg3;
- (void)dvt_propagateAdditionalPropertiesToMutableCopy:(id)arg1;
- (void)dvt_propagateAdditionalPropertiesToImmutableCopy:(id)arg1;
@end
