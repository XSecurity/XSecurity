...
@class IDEIntegrityLogDataSource;
@class IDEGroupCore;
@class IDELaunchSession;
@class IDEIndexDatabase;
@class IDEActivityLogSection;
@protocol IDEWorkspaceReferencedTestablesObserver;
@protocol IDETestableProvider;
@class IDELocationScenarioReference;
@class IDEDeviceAppDataReference;
@class IDEWorkspace;
@class IDEGroup;
@class IDEActivityLogSection;
@class IDEIntegrityLogDataSource;
@class IDEGroupCore;
@class IDEScriptingWrapper;
@class IDEXMLPackageContainer;
...
@class IDEWorkspaceBotMonitor;
@class IDETextIndex;
@protocol DVTReferenceResolverClient;
@class IDESourceControlExtension;
@class IDESourceControlRepository;
@class IDEDirectoryBasedCustomDataStore;
...
@class IDERunnable;
@class IDESchemeIdentifier;
@class IDEInstallSchemeAction;
@class IDESchemeBuildableReference;
@class IDEBuildActionEntry;
@class IDESchemeOptionReference;
...
@class IDELogProvider;
@protocol IDEConsoleAdaptorDelegateProtocol;
@class IDEMasterPtyFileHandle;
@class IDEIssueProvider;
@class IDEIndexGenericQueryProvider;
...
@class IDETest;
@class IDETestResult;
@class IDESourceControlProject;
@class IDEIssueProviderSession;
@class IDEIssueLogRecordsGroup;
@class IDEActivityLogRecord;
@class IDEBreakpointWrapper;
@class IDERunDeviceService;
@class IDESchemeActionTestableSummary;
@class IDESchemeActionTestSummaryGroup;
@class IDESchemeActionResult;
@class IDEWorkspaceSettings;
@class IDETestableIssueProvider;
@class iDEUnitTestsOperationsObserver;
@class IDEUnitTestsOperationsObserver;
@class IDEBuildParameters;
@class IDEBuildOperationQueueSet;
@class DVTDynamicLogController;
@class IDEBuildStatisticsSection;
@class IDEBuildOperationDescription;
@class IDEBuildOperationStatus;
@class IDEDepGraphNode;
@class IDEOverridingBuildProperties;
@class DVTSystemActivityToken;
@class IDEAnalysisToolService;
@class IDESchemeActionRecord;
@class IDEArchivePathsSnapshot;
@class IDEArchivedContent;
@class IDEArchivedApplication;
@class IDEXMLPackageContainerCore;
@protocol IDEAnalysisToolService;
@class IDEInMemoryLogStore_Impl;
@class IDEInMemoryLogStore;
@class IDEOnDiskLogStore_Impl;
@class IDEOnDiskLogStore;
@class IDESchemeOptionReference;
@class IDELocationScenario;
@protocol DVTLibraryFragmentFilterDelegate;
@class DVTFileWrapper;
@class IDEXcodeServerReachabilityManager;
@class DVTLibraryFragmentFilter;
@class CSXCBotClient;
@class IDEBotSCMDefinition;
@class IDEBotExecution;
@class IDEBotSCMDefinition;
@class IDEIndexSymbolWithDefiningOccurrenceCollection;
@class IDEBotWorkingTreeDefinition;
@class IDEDataMatrix;
 ...
 * UUID: 65D65E5D-7B32-35A3-858B-C751A86E808D
 * Arch: x86_64
 *       Current version: 3582.0.0, Compatibility version: 1.0.0
 *       Source version: 3582.0.0.0.0
...
@property(readonly) NSMutableArray *mutableExecutionTrackersForDisplay; // @dynamic mutableExecutionTrackersForDisplay;
...
{
    IDESchemeIdentifier *_revlock_schemeIdentifier;
    NSString *_selectedLauncherIdentifier;
    NSString *_selectedDebuggerIdentifier;
    int _launchStyle;
...
@property(readonly) IDESchemeIdentifier *revlock_schemeIdentifier; // @synthesize revlock_schemeIdentifier=_revlock_schemeIdentifier;
//- (void).cxx_destruct;
...
- (id)testOperationForTestingSpecifiers:(id)arg1 executionEnvironment:(id)arg2 buildParameters:(id)arg3 runDestination:(id)arg4 workspace:(id)arg5 actionRecord:(id)arg6 schemeIdentifier:(id)arg7 outSchemeActionResultOperation:(id *)arg8 error:(id *)arg9 launchParametersBlock:(id)arg10 actionCallbackBlock:(void)arg11;
...
- (void)_diffPrevious:(id)arg1 current:(id)arg2 onlyNew:(id *)arg3 onlyOld:(id *)arg4 transformer:(id)arg5;
...
@property(retain) DVTStackBacktrace *creationBacktrace;
@property(readonly) DVTStackBacktrace *invalidationBacktrace;
@property(readonly) NSMutableSet *mutableTestRunSessions; // @dynamic mutableTestRunSessions;
@property(readonly) NSSet *testRunSessions; // @dynamic testRunSessions;
@property(readonly, nonatomic, getter=isValid) BOOL valid;
