 ...
 * UUID: 8D16E3CB-06D4-362C-A1F9-67C6CEF57C11
 * Arch: x86_64
 *       Current version: 3443.0.0, Compatibility version: 1.0.0
 *       Source version: 3443.0.0.0.0
...
@class IDEDiagnoticController;
@class IDESourceCodeAdjustNodeTypesRequest;
@class IDEGeneratedContentStatusContext;
@class IDEDiagnosticController;
@class IDESourceCodeEditorContainerView;
@class IDESourceCodeNavigationRequest;
@class IDESourceCodeEditorAnnotationProvider;
@class IDEAnalyzerResultsExplorer;
@class IDENoteAnnotationExplorer;
@class IDESourceCodeSingleLineBlameProvider;
@class IDESourceControlLogDetailViewController;
@class IDESingleFileProcessingToolbarController;
...
@class IDESourceCodeVersionsTwoUpSubmode;
@class IDESourceControlMergeData;
@class IDEBlameAnnotationBorderedView;
@class IDEBlameAnnotationAgeBarView;
@class IDEInspectorKeyPath;
@class IDEProcessedFileAttributes;
@protocol IDEGeniusResultNavigableRepresentedObject;
